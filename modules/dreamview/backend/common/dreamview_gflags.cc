...
DEFINE_string(static_file_dir, apollo::cyber::common::WorkRoot() + "/modules/dreamview/frontend/dist",
...
DEFINE_string(vehicles_config_path, apollo::cyber::common::WorkRoot() + "/modules/calibration/data",
