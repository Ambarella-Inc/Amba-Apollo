...
DEFINE_string(hmi_modes_config_path, apollo::cyber::common::WorkRoot() + "/modules/dreamview/conf/hmi_modes",
              "HMI modes config path.");

DEFINE_string(maps_data_path, apollo::cyber::common::WorkRoot() + "/modules/map/data", "Maps data path.");
...
HMIConfig HMIWorker::LoadConfig() {
  ...
  *config.mutable_modes() =
  ...
  AINFO<<"======================"<< FLAGS_maps_data_path <<"========================="<<FLAGS_vehicles_config_path;
